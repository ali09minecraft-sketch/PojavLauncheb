...
public class MainActivity extends BaseActivity implements ControlButtonMenuListener, EditorExitable, ServiceConnection {
    ...
    protected void initLayout(int resId) {
        ...
        if (mBinding != null && mBinding.btnModStore != null) {
            mBinding.btnModStore.setOnClickListener(new android.view.View.OnClickListener() {
                @Override
                public void onClick(android.view.View v) {
                    android.widget.Toast.makeText(MainActivity.this, "جاري الاتصال بـ Modrinth...", android.widget.Toast.LENGTH_SHORT).show();
                }
            });
        }
